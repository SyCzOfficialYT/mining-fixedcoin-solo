...
RUN STRATUM_BUILD_ONLY=1 python3 /app/stratum/server.py \
 ...
 && python3 /app/scripts/fixcoin_dashboard_liveshare_layout_patch.py \
 && python3 /app/scripts/fixcoin_dashboard_liveshare_arcane_reference_patch.py \
 && python3 -m py_compile /app/monitor/app.py /app/stratum/server.py /app/stratum/server_full.py /app/scripts/fixcoin_consensus_patch.py /app/scripts/fixcoin_network_difficulty_patch.py /app/scripts/fixcoin_stratum_difficulty_patch.py /app/scripts/fixcoin_stratum_miner_detection_patch.py /app/scripts/fixcoin_stratum_nmminer_diff_patch.py /app/scripts/fixcoin_stratum_diff_job_epoch_patch.py /app/scripts/fixcoin_dashboard_difficulty_patch.py /app/scripts/fixcoin_dashboard_realtime_patch.py /app/scripts/fixcoin_dashboard_v4_patch.py /app/scripts/fixcoin_dashboard_v4_js_patch.py /app/scripts/fixcoin_dashboard_round_authority_patch.py /app/scripts/fixcoin_dashboard_forge_patch.py /app/scripts/fixcoin_dashboard_balance_activity_patch.py /app/scripts/fixcoin_dashboard_activity_authority_patch.py /app/scripts/fixcoin_axeos_hashrate_patch.py /app/scripts/fixcoin_dashboard_reference_final_patch.py /app/scripts/fixcoin_dashboard_cyberpunk_patch.py /app/scripts/fixcoin_dashboard_core_perf_patch.py /app/scripts/fixcoin_dashboard_fx_identity_patch.py /app/scripts/fixcoin_dashboard_miner_identity_patch.py /app/scripts/fixcoin_dashboard_miner_stats_patch.py /app/scripts/fixcoin_dashboard_worker_attribution_patch.py /app/scripts/fixcoin_dashboard_block_fx_patch.py /app/scripts/fixcoin_dashboard_liveshare_layout_patch.py /app/scripts/fixcoin_dashboard_liveshare_arcane_reference_patch.py /app/scripts/fixcoin_ghostbot_webhook_patch.py /app/scripts/test_stratum_authorization.py \
