...
# Apply only deterministic backend/telemetry patches plus the repository-owned
# final reference dashboard. Historical visual layers (cyberpunk/liveshare
# route/layout/arcane overrides) are intentionally not part of the production
# build because they can overwrite or structurally move the v4 reference DOM.
