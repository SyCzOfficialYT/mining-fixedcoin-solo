...
def wallet_state(current_height):
    ...
    return {"confirmed":confirmed,"pending":rpc_pending,"immature":immature,"unconfirmed":rpc_pending+immature,"total":confirmed+rpc_pending+immature,"blocks":blocks[:100],"wallet":walletinfo or {},"error":balances_error or walletinfo_error or tx_error}
