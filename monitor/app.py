...
def status():
    ...
    info,info_error=rpc("getblockchaininfo"); net,_=rpc("getnetworkinfo"); mininginfo,_=rpc("getmininginfo"); balances,_=rpc("getbalances"); info=info or {}; net=net or {}; mininginfo=mininginfo or {}; balances=balances or {}
