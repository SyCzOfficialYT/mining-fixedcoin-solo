...
required_core_js=['motion@13.1.1/mini/+esm','repeat:Infinity','visibilitychange','fixedcoin:live']
...
print('dashboard reference final verified: FIX HUD, lightweight Motion core, event-driven feedback, mobile-safe animation, balances, candidate HUD, canonical particle primitive, and locale-safe block heights')
