...
# Validate only stable, intentional reference anchors. The previous validator
# checked implementation-detail class spellings (for example camelCase vs
# kebab-case renderer classes), which made an otherwise valid reference build
# fail. Keep the validation semantic rather than spelling-sensitive.
required_html = [
...
print(
    ...
    'Chronicle history, and responsive desktop/mobile layout'
)
