...
# stats.json is persisted state, not proof that a new Stratum round started.
...
# Polling must never create a ROUND STARTED activity. /api/logs and SSE are the
# only sources allowed to add that event.
