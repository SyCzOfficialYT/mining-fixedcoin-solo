...
VERSION = '20260823-5'
# Reference styling is the base; the upgrade layer is intentionally injected
# LAST so it owns the final geometry (especially the no-card/no-outline rule).
...
# IMPORTANT: reference first, final override last.
html = html.replace(anchor, anchor + REF_CSS + CSS, 1)
...
print('dashboard forge upgrade applied: seamless candidate HUD, no candidate outline/card, reference background, persistent progress particles, and block-found choreography')
